...
} else if ('pinigai' == $route) {
    require __DIR__.'/pinigai.php';
} else if ('istrinti' == $route) {
    require __DIR__.'/istrinti.php';
}
else {
...
<form name="naujosSaskaitos" action="naujosSaskaitos" method="post">
    <input style="color: black; background-color: gold; margin: 10px; float: left;" type="submit"
        value="Sukurti nauja saskaita">
</form>

<form name="istrinti" action="istrinti" method="post">
    <input style="color: black; background-color: gold; margin: 10px; float: left;" type="submit"
        value="Istrinti saskaita">
</form>

<form name="pinigai" action="pinigai" method="post">
    <input style="color: black; background-color: gold; margin: 10px; float: left;" type="submit"
