...
if ($_POST['Vardas'] === 0) {
    # code...
} else if (preg_match('#[0-9]#',$_POST['Vardas'])){
    $_POST['Vardas'] = 0;
...
if (isset($_SESSION["vardasPerTrumpas"])) {
    header("Location: http://localhost/NamuDarbai/Bankas/naujosSaskaitos");
    die;
}
if (isset($_SESSION["pavardePerTrumpas"])) {
    header("Location: http://localhost/NamuDarbai/Bankas/naujosSaskaitos");
